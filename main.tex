...
\usepackage[
    backend=biber,
    style=vancouver,           % Vancouver citation style
    citestyle=numeric-comp,    % Compact numeric citations
    sorting=none,              % Citations in order of appearance
    resetnumbers=true,         % Reset citation numbers per chapter
    refsegment=chapter,        % Create reference segments per chapter
    defernumbers=true          % Defer numbering until printin
]{biblatex}
...
\include{02_little_heterosis_in_potato}
\include{02_supplementary}
\include{03_efficient_genomic_prediction}
%%\include{03_supplementary}
\include{04_efficiency_mas}
\include{05_multiallelic_predictors}
\include{05_supplementary}
