...
\parencite{DeVries2023,Jansky2016}. Following the success of other crops
like sugar beet \parencite{McGrath2018} and sunflower
\parencite{Dimitrijevic2018}, both private and public ventures are
...
\parencite{Duvick1997}. This conversion in potato is actually composed of
...
inheritance \parencite{Hougas1958} with the latter comprising both
...
quality and uniformity) related advantages \parencite{Wright1980}.
...
\parencite{Zhang2019,Endelman2016,Zhang2021}.
...
\parencite{Labroo2021,Longin2013}. A large aspect of that complexity lies
...
general and specific combining abilities \parencite{Carangal1971}. It was
...
markers for genomic selection (GS) \parencite{Lande1990,Meuwissen2001}.
...
\parencite{Adams2023,Wilson2021}, but the cost associated with training
...
such as tuber shape \parencite{Eck2022}, starch content
\parencite{Li2019a}, maturity \parencite{Li2018,Massa2015} and even volume
and weight of tubers \parencite{Korontzis2020,Clot2024}. Making these
...
crops and simulation \parencite{Podlich2004, VanBerloo2008}, its utility in hybrid
...
\parencite{Adams2023}, this dataset comprises four field trials in two
...
\begin{equation} \label{eq-blup-model}
...
Using the same dataset described in \parencite{Adams2023}, marker data
...
developed by LGC \parencite{LGC2019}. For this analysis, single
...
\hat{\mathbf{y}} = \mathbf{1}\mu + \mathrm{X_Q}\beta_{Q} + \mathrm{Z_g}u + e }
\end{equation}
...
\begin{equation} \label{eq-scan-model}
\hat{\mathbf{y}} = \mathbf{1}\mu + \mathrm{X_Q}\beta_{Q} + \mathrm{Z_g}u + \mathrm{Z_{snp}}v + e }\end{equation}
...
were done using ASReml-R 4.2 \parencite{Butler2017}.
...
\begin{equation} \label{eq-mas-model}
\hat{\mathbf{y}} = \mathbf{1}\mu + \mathrm{X}_Q\beta_Q + \varepsilon }
\end{equation}
...
\hat{\mathbf{y}} =  \mathbf{1}\mu + \mathrm{W}u + \varepsilon
\end{equation}
...
scenario over the genome-wide regression scenario \parencite{Krchov2015}.
...
reasonable given trends over the past decade \parencite{Semagn2014}.
...
works \parencite{Adams2022} we know that all phenotypes studied here are highly
...
these traits in potato \parencite{Adams2023,Wilson2021}. However, the
...
\parencite{Swarup2021,Rasmusson1997}. In the context of these two tested
...
\parencite{Wurschum2012}, having dedicated mapping populations or using
extant material, and the number of individuals used
\parencite{Lande1990}. Even after QTL identification, there are common
...
sufficiently planned accordingly \parencite{ODriscoll2013,Mulder2017}.
