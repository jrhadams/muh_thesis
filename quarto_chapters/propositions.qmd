...
4. The field of agricultural science is focused on over-engineered solutions rather than the problems its created.
5. Attempting to incorporate high-dimensional biological information into statistical models, _at best_, only leads to marginal benefits in predictive modelling.
6. The Dutch are not remarkable for the number of sandwhiches they eat, but rather the deficit of passion in their preparation.
