...
With exception of a handful of published studies, the application of classical and modern biometrical methods on hybrid potato is a sparse field of research. 
...
**Chapter 5** considers the question of molecular marker information and whether multiallelic marker data has any utility in predictive applications. Two forms of multiallelic information are considered: 

**Chapter 6** we offer a synthesis of the previous experimental chapters, with a particular interest in addressing how these chapters further biometrical applications in potato. We conclude by suggesting under-served topics currently in hybrid potato.
