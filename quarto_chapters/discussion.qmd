...
Two important questions broached in **chapter's 2 & 3** dealt with the nature of gene action in hybrid potato and what population and breeding strategy should be leveraged to effectively breed for complex trait improvement. Both of these questions impact the future of what _kind_ of hybrid crop potato might be. While this thesis used inbreds derived from approximately the same ancestral source [@Lindhout2018], we can consider what future hybrid potato breeding programs might look like based upon these results.

One of the major findings of the earlier chapters was a distinct lack of SCA variance found among the panel of 806 hybrids from **chapter 2**. This was further confirmed in **chapter 3** in a genomic model were SCA variance was similarly smaller in contrast to the other genetic effects. As remarked in these chapters, this would indicate a lack of non-additive gene action at work in this population of F1 hybrids for the tuber traits in question.  

This discussion naturally leads to how a breeding program should be structured in light of these results. The immediate question pertinent to hybrid breeding is with regard to pool structure and the necessity of multiple pools. Due to the lack of 

 - SCA is a genetic residual [@Bernardo2016] (chapter 2)
         A.  Not something worth trying to predict in diploids.
         B.  Using GCA's for selection in young potato popu.
         C. [@Labroo2023]
