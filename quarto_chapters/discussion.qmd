...
Perhaps most pertinent to hybrid breeding is with regard to pool structure and the necessity of multiple pools. The development of pools in crops like maize and sugar beet was an _ad hoc_ process where complementation between distinct genetic groups was first observed, and then further developed [@]. Hybrid crops are primarily the product of a multi-pool system, however, this is dependent upon multiple conditions related both to complex trait improvement and the additional costs of logistics in multi-pool breeding. A relevant simulation study found that reciprocal recurrent selection was especially effective for multi-pool management in diploid potato, however, this was naturally contingent on the magnitude of dominance in the trait [@Labroo2023].

- TODO finish with some follow up. If breeders begin to focus on traits related seed production and on the utilization of CMS systems in potato, multi-pool hybrid breeding might very well be possible.
...
- TODO IBD founder tracing in pre-breeding generations in potato
- TODO Link to Genome Design [@Zhang2021].
