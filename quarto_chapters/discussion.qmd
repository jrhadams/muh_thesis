...
3. Implications of these results (6 paragraphs)
    ...
    ii) Multi-trait models a benefit for potato breeders. (Chapter 2)
         A.  Index selection can be of direct use to breeders.
         B.  Technical problems applying this in production.
    iii) Tuber size and dry matter content are better candidates for selection than tuber number
...
4. Future applications of statistical models (3 - 4 paragraphs)
    ...
    iv) Risk-based approach for estimating potato sensitivity.
         A.  [@Yazdi2002a]: Example of hazard models in studying longevity of a potential candidate based upon a sire's genetic value.
