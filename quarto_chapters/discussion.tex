...
evaluations and long breeding cycles \parencite{Bradshaw2017}. With the
...
power and optimal resource allocation \parencite{Schoemaker2024}. This
...
\parencite{Gopal2015,Paget2017}. This is in contrast to other field crops
...
\parencite{Zystro2018}. An overlooked property of hybrid breeding in
...
\parencite{Davies1974,Pallais1991}. The latter tend to be underpowered
...
\parencite{Storck2011,Stockem2021}. This is not without negative
...
\parencite{Anderson1981,Ortiz1997,Gu2024}. This is addressed in full in
...
for multiple tuber phenotypes \parencite{VanDijk2021a}.
...
\parencite{Gilmour1997}. The BLUEs and standard errors from these models
...
the testing of multiple linear mixed models \parencite{Velazco2017}. Both
...
\parencite{Piepho2012}. Two-stage approaches are understood to be
generally less accurate than than their single stage counterparts
especially with greater model complexity \parencite{Gogel2018}. All this
...
two chapters \parencite{Damesa2017}.
...
mode which communicates a line's value \parencite{Bertan2007}. In
...
many modern applications as well \parencite{Neele1991,Bradshaw2003}. This
...
\parencite{Plaisted1962,Tai1976,Killick1977}.
...
interdependent relationships \parencite{Gebhardt2013}. Because of this,
...
initialize these inbred populations \parencite{Lindhout2018}, these
...
heterotic pools are not genetically distinct \parencite{Zhao2015b}.
...
being allocated to the additive variance \parencite{Bernardo2016}. As a
...
genetic variance \parencite{Hill2008,Monnahan2015}. This too could be
...
\parencite{Campos2015}. It is out of scope to defend this premise of
...
applications \parencite{Walsh2004,Daetwyler2013}. In other words,
``\emph{While these {[}assumptions{]} are formally unrealistic, methods
work.}'' \parencite{Hill2010}.
...
\parencite{Duvick2004}. Hybrid crops are primarily the product of a
...
hybrid schemas being more capital intensive \parencite{Labroo2023}. The
...
\parencite{Cowling2020}. A more important consideration than genetic
...
\parencite{Keijbets2008}. Rather than seeing heterotic pooling as some
...
\parencite{McGrath2018,Eggers2024}. These are the core factors which are
...
proposed \parencite{Kempthorne1959,Bulmer1981}. Speaking to
...
attractive \parencite{Blows2009,Runcie2013}.
...
\parencite{Maris1988}. These differences are not restricted to tubers
...
generations \parencite{Gu2025}. This is true both for phenotypic
...
\parencite{Davies1974,Gopal1998}. Multivariate estimation of a
...
hybrid crops \parencite{Labroo2021}. \textbf{Chapter's 3, 4, and 5} have
...
\parencite{Sverrisdottir2017,Endelman2018,Amadeu2019,Wilson2021a,Schrauf2021}.
...
training set \parencite{Dias2019}. In many breeding programs, training
...
candidates) or sparse modification \parencite{Jarquin2020}. These are
...
\emph{identifiable} \parencite{Xenakis2019}, the sparsity of the crossing
block likely led to bias in the estimation of our genetic variances and
of any predictions of the genetic effects \parencite{Mohring2011}.
...
\parencite{Isidro2015,Berro2019,Ou2019}.
...
this cannot be fully achieved \parencite{Brachi2011}, markerset
...
effects, and trial design \parencite{Peixoto2024}. A point should also be
...
markers \parencite{Druet2014,Weber2024}. Having said this, even
...
experimental chapters \parencite{Aalborg2024,Leyva-Perez2022}.
...
applications \parencite{Guo2016,MacLeod2016,Arouisse2024}. In this vein,
...
potato's genomic diversity \parencite{Tang2022}. While recent pan-genome
...
identified \parencite{Sun2025}. Statistical models developed with the
...
systems \parencite{Mao1998,Longin2014}. Most research in potato fertility
...
\emph{StCDF1} \parencite{Clot2020,Eggers2021,Song2022}. As these loci
...
diploid potato and assess them beyond QTL \parencite{Kempe2011}. The
...
\parencite{Ortiz1997,Longin2012}. In conjunction with these traits, a
...
cytoplasm \parencite{Eggers2024}. Hybrids with P cytoplasm and homozygous
...
\parencite{Sanetomo2015}. This would have serious ramifications if
...
sensible strategy for trait improvement \parencite{Gorjanc2016}. However,
...
\parencite{Uijtewaal1987,Tai2003}. This process not only disrupts the
...
\parencite{Nyine2018,Wilson2021}. The prediction accuracy observed in
...
\parencite{Li2021}. Additionally, IBD estimation has been conducted in
shallow structured populations in tetraploids
\parencite{Amadeu2021,Song2023}. Very little methodological development
...
4.0''} \parencite{Wallace2018}. The central premise is that a crop's
...
\parencite{Varshney2021}. Breeding is no longer a practice of finding the
...
environmental sensitivity \parencite{George2017}. Formalizing the
...
potential for evaluation in potato \parencite{Souza2020,Smith2018}.
...
of a potential potato candidate \parencite{Yazdi2002a}.
