...
\item
  ...
  \item
    ...
    \item
      Using GCA's for selection in young potato populations. C.
      \autocite{Labroo2024}
    \end{enumerate}
  \item
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      Link to Genome Design \autocite{Zhang2021}.
    \item
      Access and assessment of tetraploid material.
    \end{enumerate}
  ...
  \item
    ...
    \item
      Hybrid prediction for coming cycles \autocite{Zhao2015b}.
    \end{enumerate}
  \item
    Risk-based approach for estimating potato sensitivity. A.
    Traditional stability indeces (random regression)
    ...
    \tightlist
    \item
      \autocite{Yazdi2002a}: Example of hazard models in studying
      longevity of a potential candidate based upon a sire's genetic
      value.
    \end{enumerate}
  \end{enumerate}
\item
