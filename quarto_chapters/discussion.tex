...
\subsubsection{Biometrical analysis of field
...
\subsubsection{Genomic prediction in hybrid
...
\subsubsection{Methods of selection}\label{methods-of-selection}
...
\subsection{Wider Implications}\label{wider-implications}

\subsubsection{Hybrid Breeding Schema}\label{hybrid-breeding-schema}
...
\subsubsection{Multivariate applications for potato
...
\subsubsection{Successful genomic prediction in hybrid
...
\subsubsection{Fertility Mechanisms}\label{fertility-mechanisms}
...
\subsubsection{Pre-breeding for Quantitative
...
\subsubsection{Formalization of Risk}\label{formalization-of-risk}
