...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figs_02/bv-sca-performance-1.pdf}}

}

\caption{Scatterplots for each tuber trait with (A) hybrid BLUP's
plotted with GCA's, (B) SCA's, and (C) GCA's on SCA's}
\label{fig:bv-sca-performance}
