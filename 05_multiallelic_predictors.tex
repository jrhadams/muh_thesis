...
\parencite{Mendoza1974,Tai1979,Almekinders2009}. For over a century, the
...
tetrasomic inheritance \parencite{Krantz1924,Swaminathan1954}. It was not
...
more generally
\parencite{Lian2019,Hardigan2016,Marand2019,Kyriakidou2020}. This is
...
\parencite{ThePotatoGenomeSequencingConsortium2011,Tang2022}. This also
...
\parencite{Kloosterman2013,Eck2022,Ames2024}.
...
\parencite{Vos2015,Meijer2018,Wilson2021,Endelman2024}. The latter
...
discovery in potato \parencite{Leyva-Perez2022}. The fundamental unit of
capture are a group of variants that constitute a short-range
haplotype, or to use the language of \parencite{Tinker2016}, a
...
\parencite{ThereseNavarro2022,Clot2024,Vexler2024}.
...
identity-by-descent (IBD) \parencite{Falconer1996}. Increasing interest
...
\parencite{Li2021,Garin2021}. Over the past decade, this interest has
...
\parencite{Zheng2015}. These methods become immediately interesting with
deeper and more complex pedigrees such as those found in breeding
programs \parencite{Tisne2015,VanEeuwijk2010}. Despite interest by
...
more idealized multi-parental populations \parencite{Hill2014, Garin2021}.

\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=1, bottomtitle=1mm, colback=blue!5, arc=.35mm, opacityback=1, breakable=false, left=2mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colbacktitle=blue!10!white, colframe=black, bottomrule=.15mm, coltitle=black, toptitle=1mm, title={Table 1 Description of four probesets used in hybrid prediction}, leftrule=.75mm]
(Top) The four predictor sets with the number of hybrid observations,
...
founder-derived identity-by-descent variants (IBD or IBDVs). (Bottom) Diagram of the haplotag model for all 811 probes
...
\includegraphics[width=120mm,height=140]{./figs_05/describe-seqsnp.pdf}
...
genetic applications in potato \parencite{Korontzis2020,Amadeu2021}.
...
\parencite{Adams2023}, we restrict ourselves to three important yield
...
\parencite{Lindhout2011}. These hybrids were evaluated in four yield
...
\parencite{Adams2023} with the same spatial modelling strategy leveraged
...
Using the dataset described in \parencite{Adams2023}, marker data was
...
developed by LGC \parencite{LGC2019} which included 811 targeted probes
...
\parencite{Zheng2015}. We constructed a simple analytical pipeline
...
\parencite{Heslot2013}. To ensure that our evaluation of IBD-based
...
\parencite{Da2015} and \parencite{Schaid2004} for the genetic partitioning
...
of a general bridge model \parencite{Friedman2010}.
...
\parencite{Ogutu2014}. Adapting the same notation from above, the group
...
was done using the \texttt{gglasso} R package \parencite{Yang2015}. Estimated parameters were measured for all LASSO models (See Supplementary section 3).

The last predictive method we tested was the Gaussian Kernel framework
proposed by \parencite{Perez-Elizalde2015}. The primary motivation was to
...
\parencite{Perez-Elizalde2015} with a total MCMC iterations of 77,000 and
...
performance statistics \parencite{Hsu2017}. These include the prediction
...
trial datasets from \parencite{Adams2023}, we were able to estimate the
...
{\centering \includegraphics[width=\textwidth,height=100mm]{./figs_05/fig-ibd-1.pdf}
...
{\centering \includegraphics[width=\textwidth,height=140mm]{./figs_05/fig-pa-1.pdf}
...
\parencite{Schaid2004}.

\begin{figure}

{\centering \includegraphics[width=\textwidth,height=140mm]{./figs_05/fig-gca-1.pdf}
...
\parencite{Endelman2011} or Bayesian \parencite{Gianola2008}, reproducing
...
popularity in the GP/GS space \parencite{Crossa2019}. We were also
...
diversity in the founding population \parencite{ThereseNavarro2022}. Not
...
over that of simpler IBS formulations \parencite{Maurer2016,Maurer2017}.
...
\parencite{VanEeuwijk2010}. However, this leads to issues of
